        ...
        var a = e("./GameManager")
            ...
            return o(t, e),
                ...
                t.prototype.start = function() {
                    ...
                    var n = i.default.returnCurrentLanType();
                    this.adsButton2.active = 1 == n,
                ...
                t.prototype.OnClickMoreGame = function() {
                    this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this),
                        this.canClick = !1,
                        this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, .7), cc.scaleTo(.1, .6))),
                        this.scheduleOnce(function() {
                            window.location.href = "http://vsane.com/"
                        }, .15),
                        cc.log(111111111111))
                }
                ,
        ...
        var a = e("./GameFunction")
            ...
            return o(t, e),
                ...
                t.prototype.onTouchMove = function(e) {
                    i.default.playerTouch && null != a.default.Instance.targetFruit && (this.touchNum = 1,
                        a.default.Instance.targetFruit.x = this.node.convertToNodeSpaceAR(e.getLocation()).x)
                }
                ,
                t.prototype.onTouchEnd = function(e) {
                    var t = this;
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0,
                        ...
                        this.scheduleOnce(function() {
                            i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(2),
                                t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(2),
                                t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(3),
                                t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(4),
                                ...
                                t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(s.default.RandomInteger(2, 6)),
                                t.createFruitCount++))
                        }, .5))
                }
                ,
        ...
        cc.Class({
            ...
            initEndLayer: function() {
                this.gameOverT1.node.active = !1,
                    ...
                    1 == this.returnCurrentLanType() ? this.showAdsLayer() : o.publicGameBool || adBreak({
                        type: "next",
                        name: "restart-game"
                    }),
                    a.gotoEndLayer1()
            ...
            showAdsLayer: function() {
                cc.find("Canvas/adsLayer").active = !0,
                    cc.find("Canvas/adsLayer").setContentSize(cc.winSize.width, cc.winSize.height)
            },
            AdsLink: function() {
                window.location.href = "https://activity.doumobfour.club/horse?appkey=8fa2be346ab599d74b7b35732652ab4d&adSpaceKey=d85ac81f682a1498afbd9263d931af62&from=H5&1=1"
            },
    ...
    MainGameUi: [function(e, t, n) {
        ...
        var a = e("../common/PlayerInfo")
            ...
            return o(t, e),
                ...
                t.prototype.start = function() {
                    this.ShowScorePanel(),
                        s.default.Instance.GetLevel() % 5 == 1 ? (this.passlevelYQ = .12,
                            ...
                            this.lerpCtrl = !0);
                    var e = l.default.returnCurrentLanType();
                    this.adsButton.active = 1 == e,
                        cc.tween(this.adsButton.children[0].children[0]).to(.5, {
                            scale: 1.2
                        }).to(.5, {
                            scale: 1
                        }).union().repeatForever().start()
                ...
                ,
                t.Instance = null,
                c([p(cc.Node)], t.prototype, "mainCamera", void 0),
                c([p(cc.Node)], t.prototype, "bgLayer", void 0),
                c([p(cc.Label)], t.prototype, "scoreLabel", void 0),
                c([p(cc.Node)], t.prototype, "scorePanel", void 0),
                c([p(cc.Node)], t.prototype, "guidePanel", void 0),
                c([p(cc.Node)], t.prototype, "injuredPanel", void 0),
                c([p(cc.Node)], t.prototype, "levelPanel", void 0),
                c([p(cc.Node)], t.prototype, "levelProgress", void 0),
                c([p(cc.Node)], t.prototype, "heartPanel", void 0),
                c([p(cc.Node)], t.prototype, "congratulation", void 0),
                c([p(cc.Node)], t.prototype, "adsButton", void 0),
                c([p(cc.Node)], t.prototype, "player", void 0),
                t = n = c([d], t)
        }(cc.Component);
        n.default = f,
            cc._RF.pop()
